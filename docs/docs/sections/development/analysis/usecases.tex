Para la correcta visualización de los modelos de casos de uso se han subdividido por los módulos descritos en los requisitos funcionales \ref{sec:FunctionalRequirements}.

Se asume que los casos de Uso en los que interviene el rol de comercial también pueden ser realizador por el rol de admin, por lo que se ha representado únicamente el rol de comercial para evitar la redundancia. No obstante, en los diagramas que tienen casos de uso en los que interviene exclusivamente el rol de admin, sí se ha representado.
...
En este módulo se han representado los casos de uso relacionados con funcionalidades futuras. Dado que las funcionalidades recogidas en este módulo no forman parte del alcance principal de la primera versión del sistema, el diagrama de casos de uso asociado debe interpretarse como una representación conceptual de posibles extensiones futuras de la plataforma.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./figures/UML/CasosDeUso/M8_CasosDeUso.pdf}
    \caption{Casos de Uso M8. Funcionalidades futuras}
