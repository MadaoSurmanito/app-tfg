Para la correcta visualización del modelo de casos de uso se ha subdividido según los módulos descritos en los requisitos funcionales \ref{sec:FunctionalRequirements}.
