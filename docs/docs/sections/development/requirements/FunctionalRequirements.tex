...
% ------------------------------------------------------------------------------
\subsection{M5. Gestión interna de peluquerías}
% ------------------------------------------------------------------------------

Este módulo agrupa las funcionalidades destinadas a facilitar la gestión interna del salón por parte de las peluquerías usuarias del sistema. Su objetivo es proporcionar herramientas que permitan organizar la actividad diaria del establecimiento, gestionar las citas y los profesionales del equipo, así como registrar información técnica asociada a los servicios realizados a los clientes finales.

\subsubsection{RF-M5-01 Gestión de clientes del salón y seguimiento técnico}

\begin{itemize}
    \item El sistema debe permitir registrar información básica de los clientes del salón necesaria para la gestión de citas y servicios.
    \item El sistema debe permitir asociar a cada cliente los servicios o tratamientos realizados en el salón.
    \item El sistema debe permitir almacenar información técnica relevante asociada a dichos servicios, como fórmulas de coloración utilizadas, productos utilizados o tratamientos aplicados.
    \item El sistema debe permitir consultar el historial de servicios y tratamientos asociados a cada cliente para facilitar el seguimiento de trabajos técnicos previos.
\end{itemize}

\subsubsection{RF-M5-02 Gestión de agenda y citas}

\textbf {DUDA:  Si el objetivo del sistema es aumentar la fidelización de los clientes profesionales, ¿tiene sentido incluir funcionalidades de gestión de citas para los clientes finales del salón? Está claro que esto puede ser un valor añadido para las peluquerías, pero no sé si es un requisito imprescindible o si se podría plantear como una funcionalidad adicional a desarrollar en una fase posterior. El único motivo por el que queremos información de los clientes finales es para poder registrar los servicios realizados a cada uno de ellos asociados a la marca para su posterior seguimiento y análisis de datos.}

\begin{itemize}
    \item El sistema debe permitir gestionar una agenda de trabajo para la peluquería.
    \item El sistema debe permitir registrar y consultar citas asociadas a servicios del salón.
    \item El sistema debe permitir asignar cada cita a un profesional del equipo y a un intervalo temporal determinado.
    \item El sistema debe permitir visualizar la planificación de citas de forma organizada para facilitar la gestión del trabajo diario.
\end{itemize}

\subsubsection{RF-M5-03 Gestión de profesionales del salón}

\textbf {DUDA: Podríamos plantear la ficha de cliente como la de los hospitales, sin necesidad de que haya profesionales asociados a cada cliente.}

\begin{itemize}
    \item El sistema debe permitir registrar y gestionar los profesionales o empleados asociados a una peluquería.
    \item El sistema debe permitir asignar citas, servicios o tareas a los distintos profesionales del equipo.
    \item El sistema debe permitir consultar la actividad o servicios realizados por cada profesional.
\end{itemize}
