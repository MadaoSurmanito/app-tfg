...
El sistema debe almacenar información básica de cada usuario registrado en la plataforma. Esta información permite identificar al usuario, gestionar su acceso al sistema y mantener datos básicos de contacto. Los datos asociados a un usuario incluyen:
...
El sistema debe gestionar los diferentes roles que determinan los permisos y responsabilidades de los usuarios dentro de la aplicación. Los datos asociados a un rol incluyen:
...
El sistema debe almacenar las solicitudes de registro realizadas por usuarios que desean acceder a la plataforma. Estas solicitudes podrán ser revisadas por un administrador antes de conceder o denegar el acceso. Los datos asociados a una solicitud de registro incluyen:
...
\begin{itemize}
    ...
    \item Motivo de rechazo, en caso de denegación.
    \item Usuario creado a partir de la solicitud, en caso de aprobación.
\end{itemize}

\subsubsection*{Registro de administración de usuarios}

El sistema debe mantener un historial de las acciones administrativas realizadas sobre las cuentas de usuario con el objetivo de disponer de trazabilidad sobre los cambios efectuados en el sistema. Los datos asociados a cada registro de administración incluyen:
...
El sistema debe registrar los eventos relacionados con el acceso al sistema con el objetivo de mejorar la seguridad, detectar accesos indebidos y disponer de información para auditoría. Los datos asociados a un registro de acceso incluyen:
...
\begin{itemize}
    ...
    \item Información del agente de usuario.
...
El modelo de información del módulo M2 se ha ampliado durante el proceso de desarrollo con el fin de reflejar con mayor precisión la operativa comercial real del sistema. En consecuencia, además de la ficha básica del cliente profesional, se incorporan estructuras orientadas a representar el perfil comercial, las asignaciones entre clientes y comerciales, las visitas planificadas o realizadas y las rutas de trabajo.

\subsubsection*{Cliente}

El sistema debe almacenar la información básica de cada cliente profesional atendido por el distribuidor. Esta información permite identificar cada establecimiento, registrar sus datos de contacto y localización, mantener su relación con la cuenta de acceso correspondiente dentro del sistema y servir de base para el seguimiento comercial posterior.
...
El sistema debe permitir representar a los usuarios de tipo comercial mediante una estructura de información específica asociada a su cuenta de usuario. Esta información permite distinguir el perfil operativo del comercial dentro del sistema y registrar datos complementarios de uso interno.

Los datos asociados a un comercial incluyen:

\begin{itemize}
    \item Identificador del comercial.
    \item Usuario asociado al perfil comercial.
    \item Código interno o identificador profesional, cuando exista.
    \item Territorio, zona o ámbito de trabajo asignado.
    \item Notas internas asociadas al perfil comercial.
    \item Fecha de creación del perfil comercial.
    \item Fecha de última actualización del perfil comercial.
\end{itemize}

\subsubsection*{Asignación cliente-comercial}

El sistema debe permitir registrar la relación entre un cliente profesional y un comercial determinado. Esta estructura evita modelar la responsabilidad comercial como un simple atributo fijo del cliente y permite reflejar cambios, reasignaciones y trazabilidad histórica.

Los datos asociados a una asignación cliente-comercial incluyen:
...
\begin{itemize}
    ...
    \item Fecha y hora de finalización de la asignación, en caso de existir.
    \item Usuario que registró la asignación, cuando dicha información esté disponible.
    \item Usuario que registró la finalización de la asignación, cuando corresponda.
    \item Notas asociadas a la asignación.
\end{itemize}

\subsubsection*{Estado de visita comercial}

El sistema debe gestionar un catálogo de estados de visita comercial que permita clasificar la situación de cada visita registrada.

Los datos asociados a un estado de visita comercial incluyen:

\begin{itemize}
    \item Identificador del estado.
    \item Código del estado.
    \item Nombre del estado.
\end{itemize}

\subsubsection*{Visita comercial}

El sistema debe permitir registrar las visitas comerciales realizadas o planificadas por los agentes a los clientes profesionales. Estas visitas permiten documentar la actividad comercial y registrar observaciones o resultados obtenidos durante la interacción con el cliente.
...
\begin{itemize}
    ...
    \item Comercial que realiza o planifica la visita.
    \item Fecha y hora previstas para la visita.
...
El sistema debe gestionar un catálogo de estados de ruta comercial que permita reflejar la situación operativa de cada ruta registrada.

Los datos asociados a un estado de ruta comercial incluyen:
...
El sistema debe permitir organizar las rutas de trabajo de los agentes comerciales. Una ruta representa la planificación de visitas que un comercial debe realizar durante una jornada o recorrido determinado.

Los datos asociados a una ruta comercial incluyen:

\begin{itemize}
    \item Identificador de la ruta.
    \item Comercial responsable de la ruta.
    \item Fecha de la ruta.
...
El sistema debe permitir registrar la inclusión de visitas comerciales concretas dentro de una ruta, así como el orden previsto de ejecución de cada una de ellas.

Los datos asociados a una visita en ruta incluyen:

\begin{itemize}
    \item Identificador del registro.
    \item Ruta comercial asociada.
    \item Visita comercial incluida.
    \item Orden de la visita dentro de la ruta.
\end{itemize}
