...
No se requieren características hardware especiales más allá de las necesarias para ejecutar herramientas modernas de desarrollo web, contenedores Docker y utilidades de compilación documental.
...
Para la elaboración de la memoria técnica y la gestión del proyecto se emplearon las siguientes herramientas:
...
\begin{itemize}
    ...
    \item DBeaver para la gestión visual de la base de datos PostgreSQL.
\end{itemize}

\subsection{Instalación del entorno local}

El repositorio se estructura en dos bloques principales: la aplicación software, ubicada en el directorio \texttt{app-tfg/}, y la documentación técnica en \LaTeX, ubicada en \texttt{docs//}. Esta organización permite separar con claridad la evolución del producto software de la evolución de la memoria, manteniendo la coherencia entre ambas.
