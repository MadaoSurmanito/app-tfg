...
En el marco del presente Trabajo Fin de Grado, el desarrollo se ha iniciado con la implementación de la base funcional del sistema, incluyendo la gestión de acceso, autenticación de usuarios, control de roles, administración de usuarios y mecanismos de trazabilidad y seguridad. Estas funcionalidades constituyen el núcleo sobre el que se apoyará la evolución del sistema y la incorporación progresiva del resto de módulos definidos.